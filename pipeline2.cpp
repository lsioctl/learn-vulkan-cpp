...
void createGraphicsPipeline(
    ...
    if (vkCreatePipelineLayout(logical_device, &pipelineLayoutInfo, nullptr, pPipelineLayout) != VK_SUCCESS) {
    ...
    if (vkCreateGraphicsPipelines(logical_device, VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, pGraphicsPipeline) != VK_SUCCESS) {
